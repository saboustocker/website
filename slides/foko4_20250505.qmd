...
:::{.v-center-container}
![Paired samples of specifications tested against each other, paired by common denominators through other specifications.](images_foko/samples_together_example.svg){#fig-pairedsamples width=1600px}
:::
...
- licence / app - okay to be public? 
- hand in of master's thesis: email, to whom, who to CC and what to consider? 
